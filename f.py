...
class Computer:
    ...
    def set_video_card(self, new_vidio_card):
        self.__video_card = new_vidio_card
    ...
    def get_motherboard(self):
        return self.get_motherboard
    
    def set_motherboard(self, new_motherboard):
        self.set_motherboard = new_motherboard

    def get_random_access_memory(self):
        return self.random_access_memory

    def set_random_access_memory(self, new_random_access_memory):
        self.random_access_memory = new_random_access_memory

    def get_ssd_drive(self):
        return self.ssd_drive

    def set_ssd_drive(self, new_ssd_drive):
        self.ssd_drive = new_ssd_drive
